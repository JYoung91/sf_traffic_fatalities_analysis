...
```{r}
ggplot(CollisionRecordsCleaned, aes(PCF_Violation, Collision_Severity, fill = Collision_Severity)) +
    geom_tile() +
    theme(axis.text.x = element_text(angle = 45, hjust = 1)) +
    scale_x_discrete(name ="Primary Collision Factor") +
    scale_y_discrete(name ="Collision Severity")

ggplot(CollisionRecordsCleaned, aes(Light_Condition, Collision_Severity)) +
    geom_jitter() +
    theme(axis.text.x = element_text(angle = 45, hjust = 1)) +
    scale_x_discrete(name ="Light Condition") +
    scale_y_discrete(name ="Collision Severity")
  
ggplot(CollisionRecordsCleaned, aes(Road_Surface, Collision_Severity)) +
    geom_jitter() +
    theme(axis.text.x = element_text(angle = 45, hjust = 1)) +
    scale_x_discrete(name ="Road Surface") +
    scale_y_discrete(name ="Collision Severity")  

ggplot(CollisionRecordsCleaned, aes(Pedestrian_Action, Collision_Severity)) +
    geom_jitter() +
    theme(axis.text.x = element_text(angle = 45, hjust = 1)) +
...
ggplot(CollisionRecordsCleaned, aes(Collision_Type, Collision_Severity)) +
    geom_jitter() +
    theme(axis.text.x = element_text(angle = 45, hjust = 1)) +
